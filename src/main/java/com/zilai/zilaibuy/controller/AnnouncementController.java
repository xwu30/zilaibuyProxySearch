...
public class AnnouncementController {
    ...
    record AnnouncementDto(Long id, String title, String titleEn, String tag, boolean isPinned, String publishDate) {
        static AnnouncementDto from(AnnouncementEntity e) {
            return new AnnouncementDto(e.getId(), e.getTitle(), e.getTitleEn(), e.getTag(), e.isPinned(),
                    e.getPublishDate().toString());
        }
    }

    record SaveRequest(String title, String titleEn, String tag, boolean isPinned, String publishDate) {}
    ...
    public ResponseEntity<AnnouncementDto> create(
        ...
        e.setTitleEn(req.titleEn() != null && !req.titleEn().isBlank() ? req.titleEn() : null);
