...
public class UserEntity {
    ...
    @Column(name = "cloud_id", unique = true, length = 20)
    ...
    @Column(name = "balance_jpy", nullable = false, columnDefinition = "DECIMAL(12,2) DEFAULT 0.00")
    private java.math.BigDecimal balanceJpy = java.math.BigDecimal.ZERO;
