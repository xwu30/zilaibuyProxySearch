...
public class RakutenProperties {
    ...
    public String getBooksAccessKey() { return booksAccessKey; }
    public void setBooksAccessKey(String booksAccessKey) { this.booksAccessKey = booksAccessKey; }
